...
Temporary isolated preview repository used only to build and test the Claude integration ZIP.

- Original hackathon repository is not modified by this preview.
- The preview build uses GitHub Pages compatibility changes only: Vite base path, hash routing, and local PWA icons.
